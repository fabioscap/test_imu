...
namespace srrg2_solver {
  ...
  public:
    ...
    void setMeasurement(test_imu::ImuPreintegrator& preintegrator);
  ...
  class ImuPreintegrationFactorUKFAD
    : public ADErrorFactor_<15,
                            VariableSE3QuaternionRightAD, // pose_from
                            VariableVector3AD,            // vel_from
                            VariableSE3QuaternionRightAD, // pose_to
                            VariableVector3AD,            // vel_to
  ...
  public:
    ...
    void setMeasurement(test_imu::ImuPreintegratorUKF& preintegrator);
